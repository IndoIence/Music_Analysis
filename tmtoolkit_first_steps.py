# %%
from utils import get_artists, CONFIG, sanitize_art_name 
...
c_small = Corpus({k:v for k,v in get_art_documents()}, spacy_instance=nlp, max_workers=0.1)
